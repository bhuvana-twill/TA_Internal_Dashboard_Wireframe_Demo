...
export const mockCandidates: Candidate[] = [
  ...
  createCandidate('cand-001', 'Alice Johnson', 'role-001', 'member_referral', 'submitted', 10, 4),
  createCandidate('cand-002', 'Bob Smith', 'role-001', 'member_partner', 'qualified', 15, 6),
  createCandidate('cand-003', 'Carol White', 'role-001', 'ta_sourced', 'twill_interview', 18, 2),
  createCandidate('cand-004', 'David Brown', 'role-001', 'member_referral', 'in_client_process', 25, 1),
  createCandidate('cand-005', 'Eve Davis', 'role-001', 'member_partner', 'in_client_process', 20, 1),

  // Role 002 - Product Manager (Sarah Johnson)
  createCandidate('cand-006', 'Frank Miller', 'role-002', 'member_referral', 'submitted', 8, 3),
  createCandidate('cand-007', 'Grace Lee', 'role-002', 'ta_sourced', 'qualified', 12, 7),
  createCandidate('cand-008', 'Henry Wilson', 'role-002', 'member_partner', 'final_stages', 22, 1),
  createCandidate('cand-009', 'Iris Martinez', 'role-002', 'member_referral', 'middle_stages', 18, 2),
