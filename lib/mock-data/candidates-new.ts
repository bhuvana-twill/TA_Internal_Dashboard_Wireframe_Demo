...
export const mockCandidates: Candidate[] = [
  ...
  createCandidate('cand-002', 'Bob Smith', 'bob.s@example.com', 'role-001', 'member_partner', 'qualified', 5, undefined, 'partner-001'),
  ...
  createCandidate('cand-005', 'Eve Davis', 'eve.d@example.com', 'role-001', 'member_partner', 'in_client_process', 15, undefined, 'partner-001'),
  ...
  createCandidate('cand-008', 'Henry Wilson', 'henry.w@example.com', 'role-001', 'member_partner', 'fit_and_hold', 6, undefined, 'partner-001'),
  ...
  createCandidate('cand-011', 'Kate Anderson', 'kate.a@example.com', 'role-002', 'member_partner', 'submitted', 8, undefined, 'partner-002'),
  ...
  createCandidate('cand-014', 'Noah Harris', 'noah.h@example.com', 'role-002', 'member_partner', 'verbal_offer', 30, undefined, 'partner-002'),

  // Role 003 - Backend Engineer
  createCandidate('cand-015', 'Olivia Clark', 'olivia.c@example.com', 'role-003', 'member_referral', 'no_status', 3),
  createCandidate('cand-016', 'Peter Lewis', 'peter.l@example.com', 'role-003', 'member_partner', 'qualified', 6, undefined, 'partner-005'),
  ...
  createCandidate('cand-019', 'Sam Allen', 'sam.a@example.com', 'role-004', 'member_partner', 'no_status', 6, 6, 'partner-004'), // 6 days in no_status
  ...
  createCandidate('cand-019d', 'Dana Foster', 'dana.f@example.com', 'role-004', 'member_partner', 'no_status', 2, 2, 'partner-004'), // 2 days in no_status
  ...
  createCandidate('cand-022', 'Victor Scott', 'victor.s@example.com', 'role-004', 'member_partner', 'rejection_1', 16, undefined, 'partner-004'),
  ...
  createCandidate('cand-025', 'Yara Baker', 'yara.b@example.com', 'role-006', 'member_partner', 'submitted', 8, undefined, 'partner-005'),
